...
(21, 'The Lambda Liar', 
 ...
 '[\'Bo\', \'Ann\', \'Christopher\']', 
 'The sort method key argument expects a function. Use lambda x: len(x).',
 'Replace lambda x: 0 with lambda x: len(x) to sort by length.',
...
(22, 'The Map Murder', 
 ...
 '[10, 20, 30]', 
 'The map function applies a transformation to every item.',
 'Use lambda x: int(x.replace("$", "")) or slice int(x[1:]) inside the map.',
...
(23, 'The Generator Ghost', 
 ...
 '0\n1', 
 'Generators yield values one at a time instead of storing a full list.',
 'The provided code correctly uses yield. Just run it to verify.',
...
(24, 'The Regex Ripper', 
 ...
 'v@k.com', 
 'The regex pattern needs to match non-whitespace characters around an @ symbol.',
 'Try a pattern like r"\\S+@\\S+" or r"[\\w\\.-]+@[\\w\\.-]+".',
...
(25, 'The Classy Criminal', 
 ...
 '9', 
 'Use self.variable_name to modify instance attributes.',
 'Replace pass with self.ammo -= 1.',
...
(26, 'The Inheritance Inheritance', 
 ...
 'Sherlock', 
 'When overriding __init__, you must call super().__init__(...) to initialize the parent.',
 'Add super().__init__(name) inside the Detective constructor.',
...
(27, 'The Decorator Death', 
 ...
 'Access Granted', 
 'A decorator must define a wrapper function that calls the original function if conditions are met.',
 'Define a wrapper() inside check_check that checks has_badge, then calls func(). Return wrapper.',
...
(28, 'The Time Complexity Trap', 
 ...
 '3', 
 'Linear search (index()) is too slow for large lists. Binary search is much faster.',
 'The code provided correctly uses bisect.bisect_left. Verify it runs.',
...
(29, 'The Binary Body', 
 ...
 'Access', 
 'Bitwise AND (&) compares bits. 101 & 100 = 100 (True).',
 'The code is correct. Just ensure you use the single ampersand &.',
...
(30, 'The Algorithm Alibi', 
 ...
 'Or use sorted(dna) to get a new sorted list.',
